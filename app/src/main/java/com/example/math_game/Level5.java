...
public class Level5 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialog5); // path to layout
...
//_______________________________________________________________________________
        ...
        dialogend.setContentView(R.layout.dialogend5); // path to layout
...
//___________________________________________________________________
    ...
    private void getQuestionList(){
        ...
        firestore.collection("Level5").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(Level5.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
                dialogend.cancel();
