...
public class Level3 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialog3); // path to layout
...
//_______________________________________________________________________________
        ...
        dialogend.setContentView(R.layout.dialogend3); // path to layout
...
//___________________________________________________________________
    ...
    private void getQuestionList(){
        ...
        firestore.collection("Levels 3").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(Level3.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
                dialogend.cancel();
