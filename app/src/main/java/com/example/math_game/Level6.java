...
public class Level6 extends AppCompatActivity  implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.previewdialog6); // path to layout
...
//_______________________________________________________________________________
        ...
        dialogend.setContentView(R.layout.dialogend6); // path to layout
        ...
        //button 'end'
        Button btn_continue2 = (Button)dialogend.findViewById(R.id.end);
...
//___________________________________________________________________
    ...
    private void getQuestionList(){
        ...
        firestore.collection("Level6").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(Level6.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
                dialogend.cancel();
